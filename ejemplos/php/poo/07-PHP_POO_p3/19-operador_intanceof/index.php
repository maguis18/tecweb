    ...
    <?php
        ...
        for($i=0; $i<count($vec); $i++) {
            ...
            if($vec[$i] instanceof Empleado) {
                ...
                //retorna el sueldo solo de empleados
            }
            //El operador instanceof evalúa a true si el objeto a su 
            // izquierda es una instancia de la clase/interfaz
            //a su derecha o una instancia de una subclase de esa clase
            else {
                // USO DEL OPERADOR instanceof
                if($vec[$i] instanceof Gerente) {
                    $suma2 += $vec[$i]->retornarSueldo();
                }
                //retorna el sueldo solo de gerentes
            }
        }
