...
function buscarID(e) {
    ...
    client.onreadystatechange = function () {
        if (client.readyState == 4 && client.status == 200) {
            ...
            // SE OBTIENE EL OBJETO (o Array) DE DATOS A PARTIR DE UN STRING JSON
            let productos = JSON.parse(client.responseText);

            // Verificamos que la respuesta no sea vacía
            if (productos.length > 0) {
                // Si 'productos' es un array, recorremos cada uno
                let template = '';
                ...
                // Si no encontró nada, podrías limpiar la tabla o mostrar un mensaje
                document.getElementById("productos").innerHTML = "<tr><td colspan='3'>No se encontraron resultados</td></tr>";
            }
        }
    };
    // En vez de "id="+id, enviamos "buscar="+id
    client.send("buscar=" + id);
}
